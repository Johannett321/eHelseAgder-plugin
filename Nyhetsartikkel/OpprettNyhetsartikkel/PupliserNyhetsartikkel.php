...
function publiserNyhetsartikkel() {
    ...
    if (isset($_GET['editArticleID'])) {
        ...
        gotoViewArticle($articleID, "Artikkelen ble oppdatert!");
    }else {
        ...
        gotoViewArticle($articleID, "Artikkelen ble publisert!");
    }
}

function gotoViewArticle($articleID, $message) {
    wp_redirect("../../../../../nyheter/vis-artikkel/?artikkelID=" . $articleID . "&message=" . $message);
    exit;
}