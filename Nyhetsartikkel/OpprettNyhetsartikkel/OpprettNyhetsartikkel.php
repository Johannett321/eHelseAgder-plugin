...
function sc_opprett_nyhetsartikkel() {
    ...
    <form action = "<?php echo $postURL?>" method = "post" id = "minform" enctype="multipart/form-data">
        <div class = "innhold">
            ...
            <input type="text" id="tittel" name="tittel" placeholder="Eks.: Vi har signert kontrakt!" class = "small_input" maxlength="55" value = "<?php echo $loadedNyhetsartikkel->tittel?>"><?php addCharacterCounter("tittel");?>

            <label for="ingress" class = "labelForInput">Ingress*</label>
            <input type="text" id="ingress" name="ingress" placeholder="Eks.: Etter mange måneder med venting, har endelig kontrakten med Min Bedrift AS blitt signert." class = "small_input" maxlength="200" value = "<?php echo $loadedNyhetsartikkel->ingress?>"><?php addCharacterCounter("ingress");?>
            ...
            <div class = "uthevetBoksForm" id = "kildeboks">
                ...
                if ($loadedNyhetsartikkel == null) {
                    ...
                    <input type="text" id="skrevet_av" name="skrevet_av" placeholder="Eks.: Navn Navnesen" class = "small_input" maxlength="40" value = "<?php echo $loadedNyhetsartikkel->skrevet_av?>"><?php addCharacterCounter("skrevet_av");?>
                    <label for="rolle" class = "labelForInput">Rolle/stilling</label>
                    <input type="text" id="rolle" name="rolle" placeholder="Eks.: Prosjektleder" class = "small_input" maxlength="40" value = "<?php echo $loadedNyhetsartikkel->rolle?>"><?php addCharacterCounter("rolle");?>
                    <?php
                }else {
                    ?>
                    ...
                    <input type="text" id="endret_av" name="endret_av" placeholder="Eks.: Navn Navnesen" class = "small_input" maxlength="100" value = "<?php echo $loadedNyhetsartikkel->endret_av?>"><?php addCharacterCounter("endret_av");?>
                    <?php
                }
                ?>
            </div>
