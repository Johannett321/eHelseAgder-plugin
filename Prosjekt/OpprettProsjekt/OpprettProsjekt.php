    ...
    <form action = "kategorier<?php if (isset($_GET['editProsjektID'])) echo "?editProsjektID=" . $_GET['editProsjektID']?>" method = "post" id = "minform" enctype="multipart/form-data">
        ...
        <div class="innhold">
            ...
            <div class = "requiredPart">
                ...
                <input type="text" id="sokerkommuner" name="sokerkommuner" placeholder="Grimstad, Arendal" class = "small_input" maxlength="200" value = "<?php echo $loadedProsjekt->sokerkommuner ?>">
                <label for="samarbeidspartnere" class = "labelForInput">samarbeidspartner(e)</label>
                <input type="text" id="samarbeidspartnere" name="samarbeidspartnere" placeholder="Grimstad, Arendal" class = "small_input" maxlength="200" value = "<?php echo $loadedProsjekt->samarbeidspartnere ?>">
