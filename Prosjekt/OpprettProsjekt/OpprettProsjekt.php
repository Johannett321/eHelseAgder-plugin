    ...
    <form action = "kategorier<?php if (isset($_GET['editProsjektID'])) echo "?editProsjektID=" . $_GET['editProsjektID']?>" method = "post" id = "minform" enctype="multipart/form-data">
        ...
        <div class="innhold">
            ...
            <div class = "requiredPart">
                ...
                <input type="text" id="pname" name="pname" placeholder="Eks.: Digital Hjemmeoppfølging" class = "small_input" maxlength="55"><?php addCharacterCounter("pname");loadFieldFromLocalStorageOrEditProject("pname",$loadedProsjekt->project_name);?>
                ...
                <input type="text" id="psubtitle" name="psubtitle" placeholder="Eks.: Et EU prosjekt for å øke livskvalitet for pasienter med kronisk sykdom." class = "small_input" maxlength="100"><?php addCharacterCounter("psubtitle");loadFieldFromLocalStorageOrEditProject("psubtitle",$loadedProsjekt->undertittel);?>
                <div class = "uthevetBoksForm" id = "prosjektLederBoks">
                    ...
                    <ul id="prosjLederInputList">
                        <li><label for="pleadername" class = "labelForInput">Fullt navn*</label>
                            <input type="text" id="pleadername" name="pleadername" placeholder="Eks.: Navn Navnesen" class = "small_input" maxlength="35"></li><?php addCharacterCounter("pleadername");loadFieldFromLocalStorageOrEditProject("pleadername",$loadedProsjekt->ledernavn);?>
                ...
                <input type="text" id="prosjekteierkommuner" name="prosjekteierkommuner" placeholder="Eks.: Kristiansand" class = "small_input" maxlength="40"><?php addCharacterCounter("prosjekteierkommuner");loadFieldFromLocalStorageOrEditProject("prosjekteierkommuner",$loadedProsjekt->prosjekteierkommuner);?>
                <label for="sokerkommuner" class = "labelForInput">Søkerkommune(r)</label>
                <input type="text" id="sokerkommuner" name="sokerkommuner" placeholder="Eks.: Grimstad, Arendal" class = "small_input" maxlength="200"><?php addCharacterCounter("sokerkommuner");loadFieldFromLocalStorageOrEditProject("sokerkommuner",$loadedProsjekt->sokerkommuner);?>
                <label for="samarbeidspartnere" class = "labelForInput">Samarbeidspartner(e)</label>
                <input type="text" id="samarbeidspartnere" name="samarbeidspartnere" placeholder="Eks.: Grimstad, Arendal" class = "small_input" maxlength="200"><?php addCharacterCounter("samarbeidspartnere");loadFieldFromLocalStorageOrEditProject("samarbeidspartnere",$loadedProsjekt->samarbeidspartnere);?>
