...
function sc_opprett_arrangement() {
    ...
    <form action = "<?php echo $postURL?>" method = "post" id = "minform" enctype="multipart/form-data">
        <div class = "innhold">
            ...
            <input type="text" id="tittel" name="tittel" placeholder="Eks.: Webinar: Digitale helsetjenester for alle" class = "small_input" maxlength="55" value = "<?php echo $loadedArrangement->tittel?>"><?php addCharacterCounter("tittel");?>
            ...
            <input type="text" id="kort_besk" name="kort_besk" placeholder="Eks.: Navn navnesen kaster lys på fremtiden for legemidler i et nytt webinar om digital legemiddelhåndtering" class = "small_input" maxlength="200" value = "<?php echo $loadedArrangement->kort_besk?>"><?php addCharacterCounter("kort_besk");?>
            ...
            <input type="text" id="sted" name="sted" placeholder="Eks.: Kristiansand" class = "small_input" maxlength="50" value = "<?php echo $loadedArrangement->sted?>"><?php addCharacterCounter("sted");?>
            <label for="arrangor" class = "labelForInput">Arrangør*</label>
            <input type="text" id="arrangor" name="arrangor" placeholder="Eks.: Kristiansand kommune" class = "small_input" maxlength="100" value = "<?php echo $loadedArrangement->arrangor?>"><?php addCharacterCounter("arrangor");?>
            <label for="kontaktperson" class = "labelForInput">Kontaktperson*</label>
            <input type="text" id="kontaktperson" name="kontaktperson" placeholder="Eks.: Navn Navnesen" class = "small_input" maxlength="100" value = "<?php echo $loadedArrangement->kontaktperson?>"><?php addCharacterCounter("kontaktperson");?>
